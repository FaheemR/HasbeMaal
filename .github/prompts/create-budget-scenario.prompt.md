...
Rules:
- Use deterministic calculations in Core.
- Represent money with `MoneyAmount` or `decimal` only.
- Make assumptions explicit.
- Add tests for edge cases and monthly/annual projections.
- Avoid presenting output as financial advice.